...
export { CommunicationColors, DefaultSpacing, Depths, FluentTheme, LocalizedFontFamilies, LocalizedFontNames, mergeThemes, MotionDurations, MotionTimings, MotionAnimations, NeutralColors, SharedColors, ComponentStyles, ComponentsStyles, PartialTheme, Theme, } from './Theme';
import './version';
