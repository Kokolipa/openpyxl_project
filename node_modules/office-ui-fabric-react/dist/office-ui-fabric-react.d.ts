...
export declare const getActivityItemClassNames: (styles: IActivityItemStyles, className: string, activityPersonas: IPersonaProps[], isCompact: boolean) => IActivityItemClassNames;

export declare const getActivityItemStyles: (theme?: ITheme, customStyles?: IActivityItemStyles | undefined, animateBeaconSignal?: boolean | undefined, beaconColorOne?: string | undefined, beaconColorTwo?: string | undefined, isCompact?: boolean | undefined) => IActivityItemStyles;
...
export declare const getShimmeredDetailsListStyles: (props: Required<Pick<import("./ShimmeredDetailsList.types").IShimmeredDetailsListProps, "theme">>) => IShimmeredDetailsListStyles;
 ...
 * conditions.
 */
export declare const GroupedListV2_unstable: React.FunctionComponent<IGroupedListV2Props>;
...
export declare class ModalBase extends React.Component<IModalProps, IDialogState> implements IModal {
    ...
    private _focusTrapZoneMergedRef;
...
declare type Target_2 = Element | string | MouseEvent | Point | Rectangle | null | React.RefObject<Element>;
