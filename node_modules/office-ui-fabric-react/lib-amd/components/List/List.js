define(["require", "exports", "tslib", "react", "../../Utilities", "./utils/canUseDom", "./utils/scroll", "./List.types"], function (require, exports, tslib_1, React, Utilities_1, canUseDom_1, scroll_1, List_types_1) {
    "use strict";
    ...
    var List = /** @class */ (function (_super) {
        ...
        function List(props) {
            ...
            _this._onRenderPage = function (pageProps, defaultRender) {
                ...
                var _d = pageProps.page, _e = _d.items, items = _e === void 0 ? [] : _e, startIndex = _d.startIndex, divProps = tslib_1.__rest(pageProps, ["page"]);
        ...
        List.prototype.render = function () {
            ...
            var finalOnRenderSurface = onRenderSurface
                ? Utilities_1.composeRenderFunction(onRenderSurface, this._onRenderSurface)
                : this._onRenderSurface;
            var finalOnRenderRoot = onRenderRoot
                ? Utilities_1.composeRenderFunction(onRenderRoot, this._onRenderRoot)
                : this._onRenderRoot;
