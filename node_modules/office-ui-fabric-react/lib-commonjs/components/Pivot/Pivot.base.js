...
var PivotBase = /** @class */ (function (_super) {
    ...
    PivotBase.prototype._renderPivotLinks = function (linkCollection, selectedKey, focusZoneProps) {
        ...
        return (React.createElement(FocusZone_1.FocusZone, tslib_1.__assign({ role: "tablist", componentRef: this._focusZone, direction: FocusZone_1.FocusZoneDirection.horizontal }, focusZoneProps, { className: Utilities_1.css(this._classNames.root, (_a = focusZoneProps) === null || _a === void 0 ? void 0 : _a.className) }), items));
    };
    /**
